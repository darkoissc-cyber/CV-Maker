...
export const LS_KEY = 'cvstudio_v2_data';
export const LS_THEME = 'cvstudio_v2_theme';
...
export const ACTION_VERBS = [
  ...
  'enhanced', 'established', 'executed', 'generated', 'grew', 'implemented',
  'improved', 'increased', 'launched', 'led', 'managed', 'optimized', 'produced',
  'reduced', 'scaled', 'streamlined',
];
